...
static const RPC_CLIENT_INTERFACE Ping___RpcClientInterface =
    {
...
RPC_IF_HANDLE Ping_v1_0_c_ifspec = (RPC_IF_HANDLE)& Ping___RpcClientInterface;
#ifdef __cplusplus
namespace {
#endif
...
static RPC_BINDING_HANDLE Ping__MIDL_AutoBindHandle;
    ...
    /* [out] */ boolean *result)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&Ping_StubDesc,
                  (PFORMAT_STRING) &ping_conf__MIDL_ProcFormatString.Format[0],
...
static const MIDL_STUB_DESC Ping_StubDesc = 
    {
    (void *)& Ping___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &Ping__MIDL_AutoBindHandle,
    0,
    0,
    0,
    0,
